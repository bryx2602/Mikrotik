...
class Loginpage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.login_label = tk.Label(self.border, text="Login to \n ISP Switch", background="white", font=("Calibre", 13))
        ...
        ##31A3DD
        self.password_entry = ctk.CTkEntry(self.border, width=150, fg_color="white", font=('Calibre', 10), border_color="#31A3DD", text_color="gray")
